...
export const siteConfig = {
  ...
  address: '6/5, Perummal Sannathi Street, Vaithilingapuram, Udangudi - 628203, Tamil Nadu, India',

  // Stats shown on About page, Hero, etc. — use your real numbers
  stats: {
    happyDrivers: '100+',      // e.g. '50+', '100+', '500+'
    servicePros: '10+',        // e.g. '5+', '20+'
    cities: '5+',              // e.g. '3+', '10+', '50+'
    avgResponse: '15 min',     // e.g. '15 min', '20 min'
  },
